...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Sửa Sản Phẩm <a href="{{route('san-pham.index')}}" class="btn btn-flat btn-success "><i
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="{{route( 'san-pham.update',['id' => $product->id] )}}" method="post" enctype="multipart/form-data" >
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="exampleInputEmail1">Ảnh Kèm Theo , Vị Trí , Hiển Thị :</label>
                                </div>
                                                        ...
                                                        <li id="li_file_{{ $item->id }}" class="">
                                                            ...
                                                            <div class="{{ $item->id}}">
                                                                ...
                                                                <div class="details_product_images">
                                                                    <input type="number" name="images_position[]" placeholder="Vị trí" min="0" value="{{ $item->position }}" class="images_position">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="exampleInputFile">Mã Màu :</label>
                            ...
                            <div class="form-group">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" value="1" name="is_hot" {{ $product->is_hot ? 'checked' : '' }}> <b>Sản phẩm Hot</b>
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" value="1" {{ $product->is_active ? 'checked' : '' }} name="is_active"> <b>Hiển thị</b>
                                    </label>
                                </div>
                            </div>
                        </div>
