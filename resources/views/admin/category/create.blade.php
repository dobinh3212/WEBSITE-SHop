                        ...
                        <form action="{{ route('danh-muc.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ old('name') }}" name="name" id="name" placeholder="Nhập tên ........">
                                     @if($errors->has('name'))
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="number" value="{{ old('position') ? old('position') : 0 }}" min="0"  class="form-control" name="position">
                                </div>
                                <div class="form-group">
                                    <label>Loại Danh Mục :</label>
                                    <select class="form-control" name="type">

                                        <option value="0" {{ (old('type') == 1) ? 'selected' :'' }} >Sản phẩm</option>
                                        <option value="1" {{ (old('type') == 2) ? 'selected' :'' }}>Tin tức</option>
                                    </select>
                                </div>
                                 <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="is_active" value="1" {{ (old('is_active') == 1) ? 'checked' :'' }}> <b>Hiển thị</b>
                                    </label>
                                </div>
                            </div>
                            <!-- /.box-body -->
